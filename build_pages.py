...
SVC = {
 "furnace-repair": {
   ...
   "intro":"When your furnace stops working, you need fast, dependable service you can trust. At Windsor Heating &amp; Cooling, we provide expert furnace repair in Windsor, Ontario and surrounding Essex County communities to restore warmth, safety, and efficiency to your home. Our skilled technicians quickly diagnose issues and deliver lasting repairs, helping you stay comfortable through every cold Ontario winter.",
   ...
   "problem_p":"Windsor Heating &amp; Cooling provides expert furnace repair in Windsor, ON to keep homes warm, safe, and efficient through the coldest months.",
   "features":[
 ...
 "ac-repair": {
   ...
   "problem_p":"Windsor Heating &amp; Cooling provides expert AC repair in Windsor, ON for central air, ductless mini-splits, and high-efficiency systems.",
   "features":[
 ...
 "ductless-ac-installation": {
   ...
   "intro":"Experience reliable, energy-efficient cooling with professional ductless AC installation from Windsor Heating &amp; Cooling. Serving Windsor, Ontario and surrounding Essex County areas, our expert technicians install high-performance ductless air conditioning systems that provide customizable comfort year-round. Ideal for homes without traditional ductwork, our solutions deliver quiet, efficient cooling while helping you save on energy costs.",
   ...
   "problem_p":"Windsor Heating &amp; Cooling provides ductless AC installation for efficient, flexible cooling that reduces energy costs and keeps every room comfortable.",
   "features":[
 ...
 "fireplace-installation": {
   ...
   "intro":"Enhance your home's warmth and style with professional fireplace installation from Windsor Heating &amp; Cooling. Serving Windsor, Ontario and surrounding Essex County areas, our skilled team ensures safe, efficient, and beautiful installations that complement any space. From modern gas units to classic wood-burning fireplaces, we provide expert guidance and quality workmanship to create a cozy, inviting atmosphere.",
 ...
 "thermostat-repair-replacement": {
   ...
   "intro":"Stay in control of your home's comfort with professional thermostat repair and replacement from Windsor Heating &amp; Cooling. We provide expert thermostat services in Windsor, Ontario and surrounding Essex County areas, ensuring accurate temperature control, improved energy efficiency, and reliable system performance. Whether you need a quick repair, a smart-thermostat upgrade, or a full replacement, our technicians deliver dependable solutions.",
        ...
        <div class="media-panel">
          <div class="media-panel__row">
            ...
            <div class="media-chip media-chip--wide cool" style="display:flex;align-items:center;gap:14px">
              ...
              <div><b>Real local technicians, on call 24/7</b><span>Serving Windsor &amp; Essex County, every day of the year</span></div>
            </div>
          </div>
        </div>
      </div>
...
<section class="section">
  <div class="container">
    <div class="section-head reveal">
      ...
      <h2>Why Choose Windsor Heating &amp; Cooling?</h2>
...
def build_about():
    out = head(
      ...
      desc=f"Windsor Heating & Cooling is a local, family-run HVAC company serving Windsor, Ontario with honest, reliable heating and cooling care. Meet the team.",
      path="/about/",
...
{cta_band(title="Experience the Windsor Heating &amp; Cooling Difference",
...
def build_contact():
    out = head(
      ...
      desc=f"Contact Windsor Heating & Cooling for fast, friendly HVAC service in Windsor, Ontario. Call {PHONE_DISPLAY} or request a free quote online. Open 24/7.",
      path="/contact/",
